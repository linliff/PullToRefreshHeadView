...
import com.linlif.pulltorefresh.ptr.GridViewWithHeaderAndFooter;
import com.linlif.pulltorefresh.ptr.PullToRefreshBase;
import com.linlif.pulltorefresh.ptr.PullToRefreshHeadGridView;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class HeadGirdViewActivity extends AppCompatActivity {

    private PullToRefreshHeadGridView girdView;
    ...
    private void initView() {
        ...
        girdView = (PullToRefreshHeadGridView) findViewById(R.id.pGridView);


        GridViewWithHeaderAndFooter lv = girdView.getRefreshableView();
        ...
        girdView.getRefreshableView().setNumColumns(2);
    ...
    PullToRefreshBase.OnRefreshListener2<GridViewWithHeaderAndFooter> refreshListener = new PullToRefreshBase.OnRefreshListener2<GridViewWithHeaderAndFooter>() {

        @Override
        public void onPullDownToRefresh(PullToRefreshBase<GridViewWithHeaderAndFooter> refreshView) {

            Toast.makeText(HeadGirdViewActivity.this ,"下拉刷新" ,Toast.LENGTH_SHORT).show();
        ...
        public void onPullUpToRefresh(PullToRefreshBase<GridViewWithHeaderAndFooter> refreshView) {
            Toast.makeText(HeadGirdViewActivity.this ,"上拉加载" ,Toast.LENGTH_SHORT).show();
            Thread thread =  new Thread(new Runnable() {
                @Override
                public void run() {
                    try {
