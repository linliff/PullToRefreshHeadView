 ...
 *******************************************************************************/
package com.linlif.pulltorefresh.ptr;
...
import com.linlif.pulltorefresh.R;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected final void onRestoreInstanceState(Parcelable state) {
		if (state instanceof Bundle) {
			...
			// add by mamingli 解决从后台重新调用app时，下拉菜单导致的崩溃问�?
...
//		}
	...
	public static interface OnRefreshListener2<V extends View> {
		 ...
		 */
		public void onPullDownToRefresh(final PullToRefreshBase<V> refreshView) throws InterruptedException;
